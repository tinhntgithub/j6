let host3 = "http://localhost:8080/rest";

var test3 = 0;
var key3 = null;
var form3 = {};
var url3 = "http://localhost:8080/uploads/brandImg";
...
app.controller("brand-form",function($scope,$http){
    ...
    var url3 = "http://localhost:8080/rest/uploads/brandImg";
    $scope.url = function (filename) {
        if(filename != null){
            return`${url3}/${filename}`;
        }else{
...
app.controller("brand-update",function($scope,$http){
    ...
    var url3 = "http://localhost:8080/rest/uploads/productImg";
    $scope.url = function (filename) {
        if(filename != null){
            return`${url3}/${filename}`;
        }else{
